...
export default function ProviderDashboardPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <p className="mb-6 rounded-lg border border-moss/20 bg-moss/5 p-4 text-sm text-dusk">
        Provider claims and corrections are free. Paid listing rank and provider-profile upgrades are no longer sold.
      </p>
