      ...
      <div className="prose prose-sm text-charcoal space-y-6" style={{ fontFamily: "Lora" }}>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-1">
            ...
            <li><strong>Decision</strong> — the review is either approved (published) or rejected (with reason noted internally)</li>
            <li><strong>Publication</strong> — approved reviews are displayed on the provider&apos;s listing page with the reviewer&apos;s name, rating, relationship, and date</li>
          </ol>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-bark mt-8 mb-3">6. Defamation and legal concerns</h2>
          <p>
          ...
          <h3 className="text-lg font-semibold text-bark mt-4 mb-2">6.1 If you are a care provider</h3>
          ...
          <h3 className="text-lg font-semibold text-bark mt-4 mb-2">6.2 If you are a reviewer</h3>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-bark mt-8 mb-3">7. Provider responses</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-bark mt-8 mb-3">8. Removal requests</h2>
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>Providers</strong> may request removal of a review they believe violates this policy, following the process in section 6.1</li>
        ...
        <section>
          <h2 className="text-xl font-bold text-bark mt-8 mb-3">9. Aggregate ratings</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-bark mt-8 mb-3">10. Safeguarding</h2>
          <p>
