...
function screeningState(contact: CrmContact | null, summary: Summary | null) {
  ...
  if (contact.call_suppressed || ["tps", "ctps", "invalid"].includes(contact.phone_screening_status)) {
    return { ready: false, tone: "bg-alert", title: "Do not call", detail: "TPS/CTPS, an invalid number or a CareGist objection blocks this call." };
  }
