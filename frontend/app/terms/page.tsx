    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="prose prose-sm text-charcoal space-y-6" style={{ fontFamily: "Lora" }}>
        ...
        <section>
          ...
          <p>
            CareGist is a product and online service that provides a directory of care providers
            registered with the Care Quality Commission (CQC) in England, accessible via website
            and API. CareGist is operated by H-Kay Limited, registered in England and Wales
