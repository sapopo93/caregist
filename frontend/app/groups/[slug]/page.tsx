...
import { getPublicGroup } from "@/lib/groups-api";
    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-8">
        <div className="bg-cream border border-stone rounded-lg p-5 text-center">
          ...
          {nationalAvgQuality !== null && avgQuality !== null && (
            <p className="text-xs text-dusk mt-1">
              National avg: {nationalAvgQuality}/100
              {avgQuality > nationalAvgQuality
        ...
        <div className="bg-cream border border-stone rounded-lg p-5 text-center">
          ...
          <p className="text-3xl font-bold text-clay">{pctGoodOrOutstanding ?? "—"}<span className="text-sm text-dusk">%</span></p>
          {nationalPctGood !== null && pctGoodOrOutstanding !== null && (
            <p className="text-xs text-dusk mt-1">
              National avg: {nationalPctGood}%
              {pctGoodOrOutstanding > nationalPctGood
                ? <span className="text-moss ml-1">Above average</span>
                : <span className="text-alert ml-1">Below average</span>
              }
            </p>
