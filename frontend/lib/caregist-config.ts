...
export const REVENUE_CONTROLS: RevenueControl[] = [
  {
    ...
    paywallMessage: "Upgrade to Starter for nearby search, compare, and provider monitors.",
  ...
  },
  {
    ...
    paywallMessage: "Upgrade to Business for full field access, higher export capacity, and 10,000 requests/day.",
