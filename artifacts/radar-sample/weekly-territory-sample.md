...
**Deterministic rule:** Choose the local authority with the highest count of supported events in the latest seven-day window ending on the newest source date in the snapshot (20/02/2026); break ties alphabetically by territory name.

**Selected territory:** Gloucestershire
**Supported new registrations:** 5
**Supported rating changes:** 0
