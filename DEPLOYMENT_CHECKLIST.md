...
The scheduled workflow `.github/workflows/production-smoke.yml` runs the public smoke four times a night, inside the 18:00-06:00 UK window, and on pushes to `main`.
